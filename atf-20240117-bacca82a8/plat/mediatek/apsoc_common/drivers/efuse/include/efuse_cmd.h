...
extern int efuse_read(unsigned int fuse, unsigned char *data, unsigned int len);
extern int efuse_write(unsigned int fuse, const unsigned char *data, unsigned int len);
