...
ifeq ($(CONFIG_MTK_FW_ENCRYPT_VIA_BL31),y)
	$(objtree)/tools/kernel_encrypt_add_node.sh $@ tee_aes256 kernel_key
	$(objtree)/tools/kernel_encrypt_add_node.sh $@ tee_aes256 rootfs_key
endif
ifeq ($(CONFIG_MTK_FW_ENCRYPT_VIA_OPTEE),y)
	$(objtree)/tools/kernel_encrypt_add_node.sh $@ optee_aes256 kernel_key
	$(objtree)/tools/kernel_encrypt_add_node.sh $@ optee_aes256 rootfs_key
endif
endif
