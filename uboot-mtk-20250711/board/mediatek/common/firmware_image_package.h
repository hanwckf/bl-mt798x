...
#define UUID_FW_CONFIG                                                         \
	{                                                                      \
		.atf_uuid = {                                                  \
			...
			0x8e,                                                  \
			0xd5,                                                  \
			{ 0x64, 0x8e, 0x8d, 0xdd, 0xab, 0x0e }                 \
		}                                                              \
	}

#define UUID_FIP_CHKSUM                                                        \
	{                                                                      \
		.atf_uuid = {                                                  \
			{ 0xa2, 0xcc, 0xea, 0xb7 },                            \
			{ 0xf8, 0x25 },                                        \
